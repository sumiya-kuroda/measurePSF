    ...
    methods
        ...
        function makeFigWindow(obj)
            ...
            if isempty(H)
                ...
                obj.hButton_zeroSensor = uicontrol(...
                    'Style', 'PushButton', ...
                    'Units', 'Normalized', ...
                    'Position', [0.84, 0.015, 0.15, 0.06], ...
                    'String', 'Zero Sensor', ...
                    'ToolTip', sprintf('zero sensor \n("power.zeroSensor")'), ...
                    'Parent', obj.hFig, ...
                    'Enable', 'on', ...
                    'Callback', @obj.zeroSensor);
