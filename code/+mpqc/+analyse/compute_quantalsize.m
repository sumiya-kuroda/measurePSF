function [result,dataForFit] = compute_quantalsize(frames, count_weight_gamma, min_count_proportion)
    ...
    %         - mean_photons_per_pixel: The mean number of photons pixel in "frames"
    %         - median_photons_per_pixel: The mean number of photons pixel in "frames"
    %
    ...
    result = struct(...
        ...
        'mean_photons_per_pixel', mean(single(frames(:)-zero_level)/quantal_size), ...
        'median_photons_per_pixel', median(single(frames(:)-zero_level)/quantal_size), ...
